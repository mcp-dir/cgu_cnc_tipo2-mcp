...
Controladoria-Geral da União: Certidão Negativa Correcional - Agentes Públicos (ePAD, CGU-PAD e Banco de Sanções) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [cgu_cnc_tipo2@mcp.ai](mailto:cgu_cnc_tipo2@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
